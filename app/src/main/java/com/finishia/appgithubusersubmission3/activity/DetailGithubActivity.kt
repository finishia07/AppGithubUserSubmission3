...
import com.finishia.appgithubusersubmission3.adapter.SectionPagerAdapter
                ...
                try {
                    ...
                    fab.setOnClickListener {
                        if (!statusFavorite) {
                            ...
                            values.put(FavColumns._ID, github.id)
                            values.put(FavColumns.AVATAR, github.avatar)
                            values.put(FavColumns.USERNAME, github.username)
                            values.put(FavColumns.NAME, github.name)
                            values.put(FavColumns.REPOSITORY, github.repository)
                            values.put(FavColumns.FOLLOWER, github.follower)
                            values.put(FavColumns.FOLLOWING, github.following)
                            values.put(FavColumns.COMPANY, github.company)
                            values.put(FavColumns.LOCATION, github.location)
